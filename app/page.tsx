    ...
    <div className={`${hostGrotesk.className}`}>
      <main>
        ...
        <div className={`${lusitana.className} flex flex-col text-center text-shadow-lg/100 text-white place-content-center bg-[url(/church.jpg)] w-full h-[200px] bg-cover bg-center bg-no-repeat bg-blend-darken md:h-[400px]`}>
          <h1 className="text-3xl md:text-6xl">New Hope Church of God</h1>
          ...
          <div className="basis-full md:basis-3/5 pl-1 pr-1 md:pl-4 md:pr-4">
            <div className="flex flex-col">
              <div className="aspect-video">
                ...
                <h2 className="text-l md:text-3xl m-5">Latest Sunday Service Broadcast</h2>
                <iframe src={fbLive} allowFullScreen className="relative w-full h-full"/>
              </div>

              <hr className="mt-8 mb-8 ml-16 mr-16" />

              <h2 className="text-l md:text-3xl mb-5">Visit Us</h2>
